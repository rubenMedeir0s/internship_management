                        ...
                        $id = $_SESSION['idLogin'];
                            ...
                            <tr>
                                ...
                                <tbody>
                                    <td>
                                        <?php
                                        $responsavelId = $empresa['responsavel_id'];
                                        $query = "SELECT * FROM responsavel WHERE id = $responsavelId";
                                        $queryResult = mysqli_query($conn, $query);
                                        $nome = "-1";
                                        while ($rowName = mysqli_fetch_array($queryResult)) {
                                            $nome = $rowName['nome'];
                                        }
                                ...
                                <th>Ações</th>
                                <tbody>
                                <td><a href="atualizarPerfil.php" class="btn btn-danger btn-sm-12-12">Atualizar Perfil</a></td>
                                </tbody>
                            </tr>
                        </thead>
                    </tr>
