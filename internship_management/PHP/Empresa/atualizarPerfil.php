            ...
            <div class="container-fluid">
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <?php
                        $id = $_SESSION['idLogin'];
                        $query = "SELECT * FROM empresa WHERE autenticacao_id = $id";
                        ...
                        if (mysqli_num_rows($query_run) > 0) {
                            ...
                            <form action="empresaController.php" method="POST">
                                ...
                                <div class="mb-3">
                                    <label>Morada</label>
                                    <input type="text" name="morada" value="<?= $empresa['morada']; ?>" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label>Contacto</label>
                                    <input type="text" name="telefone" value="<?= $empresa['telefone']; ?>" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label>Email</label>
                                ...
                                <div class="mb-3">
                                    <label>Site</label>
                                    <input type="text" name="site" value="<?= $empresa['site']; ?>" class="form-control">
                                </div>
                                <div>
                                    <button type="submit" value="<?= $empresa['id']; ?>" name="atualizar-perfil" class="btn btn-primary">
                                        Atualizar Perfil
                                    </button>
                                </div>
                            </form>
