                            ...
                            <div class="card-body">
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        ...
                                        ?>
                                        <form action="propostasControllerDocente.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label>Nome Docente</label><br>
                                                <?php
                                                echo '<select name="docente_id" class="form-control" value="<?php $proposta["docente_id"]; ?>" required="required">';
                                            ...
                                            <div class="mb-3">
                                                <label>PDF</label>
                                                <input type="file" name="pdf" class="form-control" style="height: 100px;"
                                                    required />
                                            </div>
                                            <div>
