    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item list-group-item-action list-group-item-light p-3"
                    href="../Propostas/viewPropostasEmpresa.php">Voltar Atrás</a>
            </div>
        </div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="propostasControllerEmpresa.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="u-form-select-wrapper">
                                ...
                                <?php
                                echo '<select name="empresa_id" class="form-control" required="required">';
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="descricao" class="form-control" style="height: 100px;"
                                    required />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="viewPropostasEmpresa.php" class="btn btn-secondary ml-2">Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
