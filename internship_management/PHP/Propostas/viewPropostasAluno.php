        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item list-group-item-action list-group-item-light p-3"
                    href="../Aluno/index.php">Voltar Atrás</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-striped">
                    <tr>
                        <td>
                            <a href="createPropostasAluno.php" class="btn btn-success btn-sm">Criar nova proposta</a>
                        </td>
                        <td>
                        ...
                        if (mysqli_num_rows($query_run) > 0) {
                            foreach ($query_run as $proposta) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="propostasControllerAluno.php" method="POST" class="d-inline">
                                    ...
                                    <td>
                                        <a href="editPropostasAluno.php?id=<?= $proposta['id']; ?>"
