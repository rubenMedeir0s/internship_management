        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-striped">
                    <tr>
                        <td>
                            <a href="responsibleregister.php" class="btn btn-success btn-sm">Criar responsável</a>
                        </td>
                    </tr>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($query_run) > 0) {
                            foreach ($query_run as $responsavel) {
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="responsavelController.php" method="POST" class="d-inline">
                                            <button type="submit" name="apagar" value="<?= $responsavel['id']; ?>"
