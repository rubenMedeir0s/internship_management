...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="areasController.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <button type="submit" name="criar" class="btn btn-primary">
                                Submeter
                            </button>
                            <a href="viewAreas.php" class="btn btn-secondary ml-2">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
