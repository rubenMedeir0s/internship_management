        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-striped">
                    <tr>
                        <td>
                            <a href="createArea.php" class="btn btn-success btn-sm">Criar nova área</a>
                        </td>
                    </tr>
                            ...
                            foreach ($query_run as $area) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editArea.php?id=<?= $area['id']; ?>"
                                            class="btn btn-info btn-sm">Atualizar</a>

                                        <form action="areasController.php" method="POST" class="d-inline">
                                            <button type="submit" name="apagar" value="<?= $area['id']; ?>"
