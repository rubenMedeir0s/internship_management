...
<head>
    ...
    <title>Criar Responsáveis</title>
    <!-- Favicon-->
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="viewResponsaveis.php">Voltar
                    Atrás</a>
            </div>
        </div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <br>
                <form action="responsibleregisterhandler.php" method="POST">
                    <table>
                        <tr>
                            <td>
                                Nome:
